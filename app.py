...
# ---------- DISCOVER META SENSORS ----------
ha_sensor("net_equity", "Delta Net Equity")
ha_sensor("robo_trading_equity", "Delta Robo Trading Equity")
    ...
    try:
        ...
        for b in data.get("result", []):
            ...
            for key, val in b.items():
                ...
                # Auto-discovery (idempotent)
                ha_sensor(sensor_id, sensor_name)
        ...
        print("📡 Full balance data sent to Home Assistant")
